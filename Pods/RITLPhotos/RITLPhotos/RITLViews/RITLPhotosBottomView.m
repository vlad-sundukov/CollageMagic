...
- (void)buildViews
{
    ...
    self.previewButton = ({
        ...
        [view setTitle:NSLocalizedString(@"Preview", @"") forState:UIControlStateNormal];
        [view setTitle:NSLocalizedString(@"Preview", @"") forState:UIControlStateDisabled];
    ...
    self.fullImageButton = ({
        ...
        [view setTitle:NSLocalizedString(@"Original", @"") forState:UIControlStateNormal];
        [view setTitle:NSLocalizedString(@"Original", @"") forState:UIControlStateSelected];
    ...
    self.sendButton = ({
        ...
        [view setTitle:NSLocalizedString(@"Send", @"") forState:UIControlStateNormal];
        [view setTitle:NSLocalizedString(@"Send", @"") forState:UIControlStateDisabled];
    ...
    [self.fullImageButton setHidden:YES];
